...
angular.module('ngTypeKit', [])
    .provider('adobeTypeKit', function () {
        var apiKey = '';
        return {
            setApiKey: function (userApiKey) {
                apiKey = userApiKey;
            },
            $get: function () {
    ...
    factory('ngTypeKitService', ['$http', 'adobeTypeKit', function ($http, adobeTypeKit) {
        var baseUrl = 'http://cors.io/?u=https://typekit.com/api/v1/json/';
        var tokenParam = '?token=' + adobeTypeKit.apiKey;
